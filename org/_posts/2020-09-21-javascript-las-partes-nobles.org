...
Este post es un pastiche de [[https://facundoolano.wordpress.com/2016/12/09/this-is-unfortunate-and-were-stuck-with-it-forever/][uno anterior]], de la época en que programaba cotidianamente en JavaScript.
Aquella vez empecé por citar a Douglas Crockford acerca de la necesidad de elegir un subconjunto de la funcionalidad (/The Good Parts/)
...
El lenguaje se llama FunScript[fn:1] y, por comodidad, voy a asumir como base [[https://www.w3schools.com/js/js_versions.asp][ECMAScript 5]], es decir: JavaScript
...
Nada muy lejos de las ideas de [[https://archive.org/details/javascriptgoodpa00croc_0/mode/2up][The Good Parts]] y [[https://es.slideshare.net/JSFestUA/js-fest-2018-douglas-crockford-the-better-parts][The Better Parts]]. Ahora que terminé con la /higienización/ inicial, pasemos
a los cambios.
...
resulta menos molesto de usar en una expresión, es decir: a nadie se le va a ocurrir la necesidad de introducir
...
Para definir variables se usa el keyword =var=, aunque su comportamiento corresponde al de =let= en JavaScript,
...
#+BEGIN_SRC javascript
obj = {}
obj = {value: 10} // TypeError: Assignment to constant variable.
obj.value = 10 // TypeError: Assignment to constant variable.
obj['another'] = 5 // TypeError: Assignment to constant variable.
